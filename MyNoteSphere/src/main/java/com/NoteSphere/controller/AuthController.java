...
public class AuthController {
	...
	public String registerUser(@ModelAttribute("registerRequest")
	RegisterRequest request,
		...
		if
		(userService.findByUsername(request.getUsername()).isPresent()) {
			result.rejectValue("username", "usernameExists", "Username already exists.");
			return "register";
		}
		
		try {
			userService.registerNewUser(request.getUsername(),
